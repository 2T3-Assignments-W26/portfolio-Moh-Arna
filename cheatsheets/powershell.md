...
+ **Features**:
  + Syntax highlighting.
  + Debugging tools _(breakpoints, step-through execution)_.
...
+ **Features**:
    ...
    + Extensions for additional functionality _(e.g., PowerShell extension)_.
